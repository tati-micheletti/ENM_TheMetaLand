...
funs<-list("https://raw.githubusercontent.com/andrefaa/ENM_TheMetaLand/master/Scripts_for_ENM_TheMetaLand/AuxiliaryFuncENM_TMLA.R",
...
ENMs_TheMetaLand(Dir="C:\\OneDrive\\ICMBIO_Modelos\\Env",
                 Sp="Species",x="Long",y="Lat",NMin=10,PCA="N",Proj="N",PabR=1,PabM="const",
                 Part="boot",SavePart="Y",Alg=c("GLM","GAM","SVM","RDF","MXS","MLK","GAU"),Thr=c("MAX"),MSDM="N",ENS=c("Mean"))
